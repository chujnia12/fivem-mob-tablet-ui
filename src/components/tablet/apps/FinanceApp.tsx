...
import { ArrowLeft, TrendingUp, TrendingDown, DollarSign, Users, RefreshCw, Eye, EyeOff, CreditCard } from 'lucide-react';
...
const FinanceApp: React.FC<FinanceAppProps> = ({ orgData, onHome }) => {
  ...
  return (
    <div className="h-full bg-gradient-to-br from-black via-gray-900 to-black text-white">
      ...
      <div className="p-8 space-y-6 overflow-y-auto custom-scrollbar" style={{ height: 'calc(100% - 5rem)' }}>
        {/* Balance Cards */}
        ...
        {/* Quick Transfer */}
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
          <h3 className="text-lg font-medium text-white mb-4">Szybki transfer</h3>
